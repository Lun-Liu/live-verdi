...
module BankArrangement (P : BankParams) = struct
  ...
  let init (n : name) = magic (final_multi_params.init_handlers (magic n))
  ...
  let handleIO (n : name) (i : input) (s : state) =
    magic (final_multi_params.input_handlers (magic n) (magic i) (magic s))
  let handleNet (d : name) (n : name) (m : msg) (s : state) =
    magic (final_multi_params.net_handlers (magic d) (magic n) (magic m) (magic s))
  ...
  let handleTimeout (n : name) (s : state) =
    magic (final_multi_params.input_handlers
